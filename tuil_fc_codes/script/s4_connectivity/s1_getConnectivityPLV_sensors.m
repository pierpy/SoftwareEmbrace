...
% Sets the paths.
config.path.sens  = '../../data/segments_fixed/';
config.path.conn  = '../../data/connectivity/plv_sensors/';
...
for findex = 1: numel ( files )
    ...
    for bindex = 1: numel ( config.bands )
        ...
        trialdata.trial = cellfun ( @(data) data - mean ( data, 1 ), trialdata.trial, 'UniformOutput', false );
